...
##### Primero debemos instalar las siguientes librerias y lo abrimos
...
![](tarea-n5-alely-crespo_files/figure-gfm/unnamed-chunk-2-1.png)<!-- -->
...
![](tarea-n5-alely-crespo_files/figure-gfm/unnamed-chunk-3-1.png)<!-- -->
...
```
    ...
    ## 
    ## =========== Homogenization of Tmax, 2001-2003. (Mon Jan 31 00:34:23 2022)
    ## 
    ...
    ## 
    ## ======== End of the missing data filling process, after 0.11 secs 
    ## 
    ## ----------- Final computations:
    ## 
...
## 4. Recortar la data mensual de Ptest desde 1965 hasta 2005. Homogeneizar dicha data mediante clústeres o áreas rectangulares, con un ancho de superposición de 0, mediante una estandarización y con gráficos de totales anuales en el análisis exploratorio de datos. Mostrar las medias de las series homogeneizadas en un archivo Excel que, además, mencione los totales anuales y los datos de latitud, longitud y nombre de cada estación (utilizar dos decimales).
...
```
    ...
    ## 
    ## =========== Homogenization of Ptest, 1965-2005. (Mon Jan 31 00:34:23 2022)
    ## 
    ...
    ## HOMOGEN() APPLICATION OUTPUT  (From R's contributed package 'climatol' 3.1.1)
    ## 
    ## =========== Homogenization of Ptest-1, 1965-2005. (Mon Jan 31 00:34:23 2022)
    ## 
    ...
    ## 
    ## ======== End of the missing data filling process, after 6.74 secs 
    ## 
    ## ----------- Final computations:
    ## 
    ## ACmx: Station maximum absolute autocorrelations of anomalies
    ...
    ## 
    ## 
    ## ======== End of homogenization of overlapping areas, after 6.83 secs 
    ## 
    ## ----------- Generated output files: -------------------------
    ## 
...
``` r
grid <- nc_open('C:/Users/Usuario/Downloads/Ptest_1965-2005_m.nc')
print(grid)
```

    ## File C:/Users/Usuario/Downloads/Ptest_1965-2005_m.nc (NC_FORMAT_CLASSIC):
    ## 
...
![](tarea-n5-alely-crespo_files/figure-gfm/unnamed-chunk-7-1.png)<!-- -->
